...
# Plugin Generator using alanos CLI
# This script demonstrates using the alanos CLI to generate plugins

echo "==================================="
echo "alanOS Plugin Generator"
echo "Using alanos CLI"
echo "==================================="
echo ""
...
if [[ ! -f "$CLI_DIR/package.json" ]] || [[ ! -d "$CLI_DIR/dist" ]]; then
    echo "❌ Could not find alanOS CLI directory"
...
{
  "name": "time-tracker",
  "description": "A plugin to display current time and manage timezone offsets for alanOS agents",
  "features": [
...
echo "Running alanos plugin generate..."
echo ""
