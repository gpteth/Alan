...
/**
 * Base character object representing alan - a versatile, helpful AI assistant.
...
/**
 * Returns the alan character with plugins ordered by priority based on environment variables.
 * This should be called after environment variables are loaded.
 *
 * @returns {Character} The alan character with appropriate plugins for the current environment
 */
export function getalanCharacter(): Character {
  const plugins = [
    // Core plugins first
    '@alanos/plugin-sql',
 ...
 * Use getalanCharacter() for environment-aware plugin loading.
 */
