...
export const agent = new Command().name('agent').description('Manage alanOS agents');
...
agent
  ...
  .addHelpText(
    ...
    `
Examples:
  $ alanos agent start -n "Agent Name"     Start an existing agent by name
  $ alanos agent start --path ./char.json  Start with a local character file
  $ alanos agent start --remote-character https://example.com/char.json

To create a new agent:
  $ alanos create -t agent my-agent-name   Create a new agent using alan template
