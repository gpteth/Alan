...
export async function upgradePlugin(pluginPath: string, opts: UpgradePluginOptions): Promise<void> {
  try {
    ...
    console.log(chalk.bold('\nalanOS Plugin Migration (0.x → 1.x)'));
    ...
    if (result.success) {
      ...
      console.log(chalk.yellow('\n🔧 Quick fixes:'));
      console.log('• Check plugin structure follows alanOS standards');
    ...
    console.log('1. Check that your plugin follows standard alanOS structure');
