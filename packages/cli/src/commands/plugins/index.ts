...
export const plugins = new Command()
  .name('plugins')
  .description('Manage alanOS plugins')
  .action(() => {
...
plugins
  ...
  .argument('<plugin>', 'plugin name (e.g., "abc", "plugin-abc", "alanos/plugin-abc")')
...
plugins
  ...
  .argument('<plugin>', 'plugins name (e.g., "abc", "plugin-abc", "alanos/plugin-abc")')
