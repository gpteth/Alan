...
@test "e2e: complete project creation and execution workflow" {
  # Create project
  run run_cli "dist" create my-alan-project --no-install
  assert_success
  assert_output --partial "Creating new alanOS project"
...
@test "e2e: plugin creation and testing workflow" {
  ...
  assert_file_contain "package.json" "@alanos/plugin-my-plugin"
