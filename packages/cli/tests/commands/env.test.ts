...
describe('alanOS Env Commands', () => {
  ...
  it('env list shows environment variables', async () => {
    ...
    result = bunExecSync('alanos env list', { encoding: 'utf8' });
  ...
  it('env list --local shows only local environment', async () => {
    ...
    const result = bunExecSync('alanos env list --local', { encoding: 'utf8' });
  ...
  it('env reset shows all necessary options', async () => {
    ...
    const result = bunExecSync('alanos env reset --yes', { encoding: 'utf8' });
