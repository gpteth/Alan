...
describe('Character Plugin Ordering', () => {
  ...
  const PLUGINS = {
    SQL: '@alanos/plugin-sql',
    BOOTSTRAP: '@alanos/plugin-bootstrap',
    OLLAMA: '@alanos/plugin-ollama',
    ANTHROPIC: '@alanos/plugin-anthropic',
    OPENAI: '@alanos/plugin-openai',
    OPENROUTER: '@alanos/plugin-openrouter',
    GOOGLE_GENAI: '@alanos/plugin-google-genai',
    DISCORD: '@alanos/plugin-discord',
    TWITTER: '@alanos/plugin-twitter',
    TELEGRAM: '@alanos/plugin-telegram',
  };
  ...
  describe('Core Plugin Ordering', () => {
    it('should always include SQL plugin first', () => {
      const character = getalanCharacter();
  ...
  describe('Plugin Order Consistency', () => {
    ...
    it('should maintain consistent order across multiple calls', () => {
      ...
      const character1 = getalanCharacter();
      const character2 = getalanCharacter();
