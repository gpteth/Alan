...
describe('Local CLI Delegation', () => {
  ...
  describe('Test Environment Detection', () => {
    ...
    it('should skip delegation when alan_TEST_MODE is true', async () => {
    ...
    it('should skip delegation when alan_SKIP_LOCAL_CLI_DELEGATION is true', async () => {
      process.env.alan_SKIP_LOCAL_CLI_DELEGATION = 'true';
      mockExistsSync.mockReturnValue(true);
  ...
  describe('Local CLI Detection', () => {
    it('should detect when running from local CLI', async () => {
      ...
      process.argv = ['node', '/test/project/node_modules/@alanos/cli/dist/index.js', 'start'];
      mockExistsSync.mockReturnValue(true);
    ...
    it('should continue when no local CLI is found', async () => {
      process.argv = ['node', '/usr/bin/alanos', 'start'];
    ...
    it('should delegate when local CLI is found and not running from it', async () => {
      process.argv = ['node', '/usr/bin/alanos', 'start', '--port', '3000'];
      mockExistsSync.mockReturnValue(true);
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Using local @alanos/cli installation');
      expect(mockSpawn).toHaveBeenCalledWith(
        process.execPath,
        ['/test/project/node_modules/@alanos/cli/dist/index.js', 'start', '--port', '3000'],
  ...
  describe('Utility Functions', () => {
    ...
    it('getCliContext should return correct context information', () => {
      ...
      expect(context.localPath).toBe('/test/project/node_modules/@alanos/cli/dist/index.js');
      expect(context.currentPath).toBe('/test/project/node_modules/@alanos/cli/dist/index.js');
    });
    ...
    it('getCliContext should return correct context when not running from local CLI', () => {
      ...
      expect(context.currentPath).toBe('/usr/bin/alanos');
    });
  });
