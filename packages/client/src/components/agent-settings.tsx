...
import type { Agent, UUID } from '@alanos/core';
import { AgentStatus } from '@alanos/core';
      ...
      try {
        ...
        if (Object.keys(changedFields).length === 0) {
          ...
          if (secrets && Object.keys(secrets).length > 0) {
            ...
            await alanClient.agents.updateAgent(agentId, forceUpdate as Partial<Agent>);
        ...
        await alanClient.agents.updateAgent(agentId, partialUpdate as Agent);
