...
const getLocalStorageApiKey = () =>
  typeof window === 'undefined' ? 'alan-api-key' : `alan-api-key-${window.location.origin}`;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Please enter the API key required to connect to the alan server. This key will be
