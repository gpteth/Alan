  ...
  const homeSteps = [
    {
      target: '.sidebar-logo',
      content:
        'Welcome to alanOS! This is your gateway to creating and managing intelligent AI agents.',
      disableBeacon: true,
      title: 'Welcome to alanOS',
    },
    {
    ...
    },
    {
      ...
      content: 'This indicator shows your connection status to the alanOS server.',
