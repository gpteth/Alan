...
// alan client refresh functionality removed (not needed with direct client)
...
export const ConnectionProvider = ({ children }: { children: ReactNode }) => {
  ...
  const refreshApiClient = useCallback((newApiKey?: string | null) => {
    try {
      ...
      // Refresh the alanClient instance with new configuration
    ...
    const onConnect = () => {
      ...
      if (isFirstConnect.current) {
        ...
        toast({
          ...
          description: 'Successfully reconnected to the alan server.',
        });
      }
    };
