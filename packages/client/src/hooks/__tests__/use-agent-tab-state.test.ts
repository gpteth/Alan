...
describe('useAgentTabState', () => {
  ...
  it('should initialize with details tab for new agent', () => {
    ...
    localStorage.setItem('alan-agent-tab-states', '{}');
  ...
  it('should load saved tab state for existing agent', async () => {
    ...
    localStorage.setItem('alan-agent-tab-states', JSON.stringify(savedStates));
  ...
  it('should save tab state when changed', async () => {
    ...
    expect(localStorage.getItem('alan-agent-tab-states')).toBe(
  ...
  it('should preserve other agent states when updating', () => {
    ...
    localStorage.setItem('alan-agent-tab-states', JSON.stringify(existingStates));
  ...
  it('should not save to localStorage when no agentId is provided', async () => {
    ...
    expect(localStorage.getItem('alan-agent-tab-states')).toBe(null);
  });
});
