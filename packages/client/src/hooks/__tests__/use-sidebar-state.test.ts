...
describe('useSidebarState', () => {
  ...
  it('should load stored state when it exists', async () => {
    localStorage.setItem('alan-agent-sidebar-visible', 'true');
  ...
  it('should save state when setSidebarVisible is called', async () => {
    ...
    expect(localStorage.getItem('alan-agent-sidebar-visible')).toBe('true');
  });
  ...
  it('should toggle state when toggleSidebar is called', async () => {
    ...
    expect(localStorage.getItem('alan-agent-sidebar-visible')).toBe('false');
  });

  it('should handle localStorage errors gracefully', () => {
    // Set up invalid JSON
    localStorage.setItem('alan-agent-sidebar-visible', 'invalid-json');
