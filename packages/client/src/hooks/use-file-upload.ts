...
import { getContentTypeFromMimeType } from '@alanos/core';
import { UUID, Media, ChannelType } from '@alanos/core';
        ...
        try {
          const uploadResult =
            chatType === ChannelType.DM && agentId
              ? await alanClient.media.uploadAgentMedia(agentId, {
                  file: fileData.file,
                  filename: fileData.file.name,
                })
              : await alanClient.media.uploadChannelMedia(channelId!, fileData.file);
