...
const MAIN_PANEL_WIDTH_KEY = 'alan-main-panel-width';
const SIDEBAR_PANEL_WIDTH_KEY = 'alan-sidebar-panel-width';
const FLOATING_THRESHOLD_KEY = 'alan-floating-threshold';
