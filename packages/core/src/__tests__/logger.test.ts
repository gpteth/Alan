...
import { createLogger, logger, alanLogger } from '../logger';
...
describe('Logger', () => {
  ...
  describe('Logger Creation', () => {
    ...
    it('should export alanLogger as alias for backward compatibility', () => {
      expect(alanLogger).toBeDefined();
      expect(alanLogger).toBe(logger);
    });
