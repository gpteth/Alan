...
authors: [team]
tags: [autofun, tokenomics, ai16z, liquidity, launchpad, alanos]
...
[auto.fun](https://auto.fun/) is the first token launch platform purpose-built for agent-native ecosystems. Designed and maintained by alan Labs, it offers a low-friction, high-alignment environment for launching new tokens and/or autonomous agents built on the alanOS stack.
...
The current phase of [auto.fun](https://auto.fun/) represents the foundation of a generative economic system. Agent developers gain tools and incentives to launch sustainably; traders benefit from deep liquidity and clean UX; and the broader alan ecosystem sees value compounded into $ai16z.
