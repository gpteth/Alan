---
slug: v1-v2
title: alanOS V2 - What's New
description: A comprehensive guide to the changes and improvements in alanOS V2 compared to V1
authors: jin
date: 2025-03-22
...
# alanOS V2: What's New

The newest version of [alan](https://github.com/alanOS/alan) represents significant upgrades from the previous version, offering a leaner, more flexible architecture for cross-platform agent interaction. This short guide highlights the key differences between V1 and V2.
...
project Manage an alanOS project
plugin Manage alanOS plugins, including publishing
agent manage alanOS agents
tee Manage TEE deployments
start [options] Start the alan agent with configurable plugins and services
update [options] Update alanOS packages to the latest versions
test [options] Run tests for alan agent plugins
...
Explore the plugin repository https://github.com/alanos-plugins/ or from the [docs showcase](/packages).
