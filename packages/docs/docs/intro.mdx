...
description: Two distinct paths to master alanOS - from beginner to expert, we've got you covered
hide_table_of_contents: true
---

import Link from '@docusaurus/Link';

# Welcome to alanOS Documentation
...
alanOS is a powerful framework for creating and deploying AI agents. Choose your learning path based on your experience and goals:
...
<div className="row margin-top--lg">
  ...
  <div className="col col--6">
    ...
    >
      ...
      <div className="card__body">
        <p style={{ color: 'rgba(255,255,255,0.95)' }}>
          For developers building custom plugins, integrations, and contributing to alanOS.
        </p>
        <ul style={{ color: 'rgba(255,255,255,0.9)' }}>
...
<div className="row margin-top--lg">
  ...
  <div className="col col--4">
    ...
    >
      ...
      <h4>Core Concepts</h4>
      <p style={{ color: '#666', fontSize: '0.9rem' }}>
        Understand alanOS architecture and patterns
      </p>
    </Link>
  </div>
</div>
...
alanOS is a powerful multi-agent simulation framework designed to create, deploy, and manage autonomous AI agents. Built with TypeScript, it provides a flexible and extensible platform for developing intelligent agents that can interact across multiple platforms while maintaining consistent personalities and knowledge.

<div style={{ textAlign: 'center', margin: '2rem 0' }}>
  <img
    src="/img/alan-architecture.jpg"
    alt="alanOS Architecture"
  ...
  <p style={{ fontSize: '0.9rem', color: '#666', marginTop: '0.5rem', fontStyle: 'italic' }}>
    alanOS Multi-Agent Architecture
  </p>
</div>
...
- **Character System**: Create diverse agents using [character files](https://github.com/alanOS/characterfile)
...
<div className="row margin-top--lg">
  ...
  <div className="col col--3">
    <Link
      className="card padding--md text--center"
      to="https://github.com/alanOS/alan"
      style={{ textDecoration: 'none', height: '100%' }}
    >
      <div style={{ fontSize: '2rem', marginBottom: '8px' }}>💻</div>
