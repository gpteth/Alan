# alanOS Plugin Testing Guide

This guide provides comprehensive instructions for writing tests for alanOS plugins using Bun's test runner.
...
import { type IAgentRuntime, type Memory, type State } from '@alanos/core';
...
import { type IAgentRuntime } from '@alanos/core';
...
**IMPORTANT**: All alanOS plugins must maintain 100% test coverage or as close to it as possible (minimum 95%).
...
This guide provides a comprehensive approach to testing alanOS plugins. Key takeaways:
