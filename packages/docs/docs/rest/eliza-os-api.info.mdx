...
id: alan-os-api
title: 'alan OS API'
description: 'API documentation for alan OS v1.0.10 - A flexible and scalable AI agent framework.'
...
<Heading as={'h1'} className={'openapi__heading'} children={'alan OS API'}></Heading>

API documentation for alan OS v1.0.10 - A flexible and scalable AI agent framework.

This API is designed to be used with a locally running alan instance. Endpoints allow for creating,
...
>
  ...
  <span>alan OS Community:</span>
  <span>URL: [https://github.com/alanos/alan](https://github.com/alanos/alan)</span>
</div>
