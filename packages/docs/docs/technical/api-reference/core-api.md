...
description: Complete API reference for alanOS core components
---

# Core API Reference

This document provides a comprehensive reference for the alanOS Core API, including all interfaces, types, and functions available for plugin and application development.
...
const character: Character = {
  ...
  plugins: ['@alanos/plugin-bootstrap'],
  settings: {
    model: 'gpt-4',
    temperature: 0.7,
  },
...
class ValidationError extends alanError {
  constructor(message: string, details?: any) {
    super(message, 'VALIDATION_ERROR', details);
  }
}

class PluginError extends alanError {
...
- [API Examples](https://github.com/alanos/alan/tree/main/examples) - Code examples
