---
title: Plugin System
description: Deep dive into alanOS plugin architecture and development
---

# Plugin System

The alanOS plugin system provides a powerful, extensible architecture for adding custom functionality to agents. This guide covers the plugin architecture, development patterns, and best practices.
...
```typescript
import { Plugin, IAgentRuntime, Action, Provider, Service } from '@alanos/core';
...
- [Core Concepts](./core-concepts.md) - Fundamental alanOS concepts
