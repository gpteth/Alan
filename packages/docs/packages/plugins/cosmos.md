...
Prepare alan according to README
Add variables required for `@alanos/plugin-cosmos` :
...
Ensure the appropriate environment variables are added for the plugin. If they are correctly configured, the project will run with `@alanos/plugin-cosmos`
