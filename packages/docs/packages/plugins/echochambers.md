...
OR copy the plugin code into your alan project node_modules directory. (node_modules\@alanos)
...
export const character: Character = {
  ...
  system: "Roleplay and generate interesting responses on behalf of alan.",
  bio: [...],
  lore: [...],
  messageExamples: [...],
  postExamples: [...],
