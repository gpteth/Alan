# Spheron Protocol Plugin for alan
...
```bash
npm install @alanos/plugin-spheron
```
...
1. You can ask the alan to deploy a template like `jupyter-notebook`, `vscode`, `ollama`, or `heurist-miner` for you with just natural language.
2. You can also customize the deployment with natural language.
3. You can also ask the alan to close the deployment.
4. You can also ask the alan to check the balance of your account.
5. You can also ask the alan to deposit or withdraw tokens from your account.
