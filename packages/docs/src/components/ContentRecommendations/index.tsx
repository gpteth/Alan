  ...
  const getAllRecommendations = (): Recommendation[] => {
    return [
      // Getting Started Recommendations
      {
        ...
        description: 'Get alanOS up and running in 5 minutes',
        url: '/docs/quickstart',
        type: 'next-step',
        difficulty: 'beginner',
        estimatedTime: '5 min',
      ...
      // Development & Advanced Topics
      {
        ...
        description: 'Create custom plugins to extend alanOS functionality',
      ...
      // Track-specific recommendations
      {
        ...
        description: 'Non-technical guide to using alanOS',
        url: '/docs/simple',
