    ...
    <section className={styles.features}>
      <div className={styles.container}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionSubtitle}>Get started with alanOS in just a few clicks</p>
          <br></br>
        </div>
        ...
        <div className={styles.quickActions}>
          ...
          <div className={styles.actionCard}>
            ...
            <div className={styles.actionLinks}>
              <Link to="/docs/awesome-alan" className={styles.actionLink}>
                Explore Resources
              </Link>
              <Link to="/docs/awesome-alan" className={styles.secondaryLink}>
                <span className={styles.secondaryLinkIcon}>📋</span> View awesome-alan
              </Link>
            </div>
          </div>
          <div className={styles.actionCard}>
            ...
            <p>Discover the organizations and projects collaborating within the alan ecosystem.</p>
            <div className={styles.actionLinks}>
          ...
          <div className={styles.actionCard}>
            ...
            <h3>🎬 Video Gallery</h3>
            <p>Watch demos, tutorials, and community showcases related to alanOS.</p>
            <div className={styles.actionLinks}>
        ...
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionSubtitle}>Explore the core components that power alanOS</p>
          <br></br>
        </div>
