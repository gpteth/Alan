        ...
        <div className={styles.heroSection}>
          <div className={styles.heroLeft}>
            <h1 className={styles.heroTitle}>
              <span className={styles.heroTitlePrefix}>alan</span> is a{' '}
            ...
            <div className={styles.buttonGroup}>
              ...
              <div className={styles.githubButton}>
                <iframe
                  src="https://ghbtns.com/github-btn.html?user=alanos&repo=alan&type=star&count=true&size=large"
                  frameBorder="0"
                  scrolling="0"
                  width="170"
                  height="30"
              ...
              <div className={styles.codeBlockWrapper}>
                ...
                <pre className={styles.codeBlock}>
                  <code>
                    ...
                    <br />
                    <span className={styles.prompt}>$</span> bun install -g @alanos/cli
                    <br />
                    <span className={styles.prompt}>$</span> alanos create
                    <br />
                  </code>
                </pre>
              </div>
