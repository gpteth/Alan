...
const TITLE = 'alanOS Packages';
const DESCRIPTION = 'Discover the awesome plugins in the alan ecosystem.';
const GITHUB_LINK = 'https://github.com/alanos-plugins/registry';
    ...
    <section className="margin-top--lg margin-bottom--lg text--center">
      ...
      <div className="alert alert--warning" style={{ marginBottom: '2rem' }}>
        ...
        <p>
          ...
          join the dev discord at <a href="https://discord.gg/alanos">discord.gg/alanos</a> for
          updates.
        </p>
      </div>
    </section>
