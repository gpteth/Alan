...
const CATEGORIES = [
  ...
  { id: 'dev', label: 'alanOS Developers' },
...
const VIDEOS = [
  ...
  {
    title: 'Agent Bazaar',
    description: 'Envisioning the bazaar of AI agents, an open AI ecosystem powered by alanOS.',
    category: 'animation',
  ...
  },
  {
    ...
    description:
      "(OLD) Complete technical walkthrough of alan's architecture, systems, and implementation details with Shaw explaining core concepts.",
    category: 'streams',
    isYouTube: true,
  ...
  },
  {
    ...
    description:
      'A tutorial on building a Firecrawl plugin for alanOS, demonstrating how to create agents that can crawl and analyze on-chain data.',
    category: 'dev',
    isYouTube: true,
  ...
  },
  {
    ...
    description:
      'Daily update covering the latest developments and contributions in the alanOS GitHub repository.',
    category: 'news',
    isYouTube: true,
