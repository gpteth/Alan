...
export async function processAIQuery(query, context = []) {
  try {
    ...
    const systemPrompt = `You are alanOS documentation assistant. You help users understand and use the alanOS framework for building AI agents. 
    
    alanOS is a powerful multi-agent simulation framework designed to create, deploy, and manage autonomous AI agents. Key features include:
