...
import { ModelType, logger, type IAgentRuntime, type Service } from '@alanos/core';
...
describe('Plugin Configuration', () => {
  it('should have correct plugin metadata', () => {
    ...
    expect(starterPlugin.description).toBe('Quick backend-only plugin template for alanOS');
