import type { IDatabaseAdapter, UUID } from '@alanos/core';
import { type IAgentRuntime, type Plugin, logger } from '@alanos/core';
 ...
 * @param {string} [config.dataDir] - The directory where data is stored. Defaults to "./.alan/.alandb".
