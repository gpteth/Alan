...
import { ModelType, Service, logger } from '@alanos/core';
import { z } from 'zod';
...
export const starterPlugin: Plugin = {
  name: 'plugin-starter',
  description: 'Plugin starter for alanOS',
  config: {
  ...
  // dependencies: ['@alanos/plugin-knowledge'], <--- plugin dependencies go here (if requires another plugin)
};
