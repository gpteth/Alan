...
const ExampleRoute = () => {
  const [config, setConfig] = React.useState(window.alan_CONFIG);
...
describe('ExampleRoute Component Tests', () => {
  ...
  describe('Configuration Handling', () => {
    it('should handle alan_CONFIG changes', () => {
...
/**
 * TESTING PATTERNS FOR FRONTEND COMPONENTS IN alanOS
 *
 ...
 *    - Always test with and without alan_CONFIG
 ...
 *     cy.setalanConfig({ agentId: 'test-id', apiBase: 'http://localhost:3000' });
 *   });
 *
 *   describe('Rendering', () => {
