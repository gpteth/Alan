 ...
 *
 * This file demonstrates how to write end-to-end (E2E) tests for alanOS projects.
 * E2E tests are run using the `alanos test` command, which provides a REAL runtime
      ...
      fn: async (runtime: any) => {
        ...
        try {
          ...
          if (character.name !== 'alan') {
            throw new Error(`Expected character name 'alan', got '${character.name}'`);
          }
