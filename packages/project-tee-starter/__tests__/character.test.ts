...
describe('Mr. TEE Character Configuration', () => {
  ...
  it('should include TEE specific plugins', () => {
    expect(character.plugins).toContain('@alanos/plugin-tee');
    expect(character.plugins).toContain('@alanos/plugin-sql');
    expect(character.plugins).toContain('@alanos/plugin-openai');
    expect(character.plugins).toContain('@alanos/plugin-discord');
