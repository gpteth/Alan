 ...
 *
 * This example demonstrates how to use @alanos/server as a standalone package
...
const exampleCharacter = {
  ...
  lore: [
    ...
    'Represents the modular architecture of alanOS.',
  ],
  messageExamples: [
    [
      {
...
async function main() {
  console.log('🚀 Starting alanOS Server independently...');
...
console.log('   alan_SERVER_AUTH_TOKEN=...  # API authentication');
