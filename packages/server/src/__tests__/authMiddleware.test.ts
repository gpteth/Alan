...
describe('API Key Auth Middleware', () => {
  ...
  describe('When alan_SERVER_AUTH_TOKEN is not set', () => {
    it('should allow all requests without authentication', () => {
      delete process.env.alan_SERVER_AUTH_TOKEN;
  ...
  describe('When alan_SERVER_AUTH_TOKEN is set', () => {
    const validToken = 'test-auth-token-12345';

    beforeEach(() => {
      process.env.alan_SERVER_AUTH_TOKEN = validToken;
    });
  ...
  describe('Edge cases', () => {
    it('should handle undefined headers object', () => {
      process.env.alan_SERVER_AUTH_TOKEN = 'test-token';
    ...
    it('should handle empty string auth token in environment', () => {
      process.env.alan_SERVER_AUTH_TOKEN = '';
