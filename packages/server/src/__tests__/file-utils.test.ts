...
describe('File Utilities', () => {
  ...
  describe('createSecureUploadDir', () => {
    it('should create valid upload directory for agents', () => {
      ...
      expect(result).toBe(
        path.resolve('/test/app', '.alan', 'data', 'uploads', 'agents', 'agent-123')
      );
    });
    ...
    it('should create valid upload directory for channels', () => {
      ...
      expect(result).toBe(
        path.resolve('/test/app', '.alan', 'data', 'uploads', 'channels', 'channel-456')
      );
    });
    ...
    it('should validate path stays within base directory', () => {
      ...
      expect(result).toContain('.alan/data/uploads/agents');
