...
import { logger, UUID } from '@alanos/core';

const TEST_CHARACTER_URL =
  'https://raw.githubusercontent.com/alanOS/alan/refs/heads/develop/packages/cli/tests/test-characters/shaw.json';

const TEST_MULTI_CHARACTER_URL =
  'https://raw.githubusercontent.com/alanOS/alan/refs/heads/develop/packages/cli/tests/test-characters/multi-chars.json';
