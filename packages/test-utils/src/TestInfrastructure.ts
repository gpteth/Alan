import type { IAgentRuntime, IDatabaseAdapter, UUID, Character, Memory } from '@alanos/core';
import { createTestRuntime } from './realRuntime';
import { stringToUuid } from '@alanos/core';
import { createUniqueUuid as _createUniqueUuid } from '@alanos/core';
...
export class TestEnvironment {
  ...
  private createTestCharacter(): Character {
    return {
      ...
      system: 'You are a test agent for alanOS integration testing.',
      messageExamples: [],
      knowledge: [],
      plugins: [],
      settings: {
