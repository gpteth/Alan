...
import type { Character, MessageExample, UUID } from '@alanos/core';
 ...
 * @example
 * ```typescript
 * import { createMockCharacter } from '@alanos/core/test-utils';
 *
 * const mockCharacter = createMockCharacter({
 *   name: 'CustomAgent',
 *   bio: ['A specialized test agent'],
 *   plugins: ['@alanos/plugin-test']
 * });
 * ```
 */
export function createMockCharacter(overrides: MockCharacterOverrides = {}): Character {
  const baseCharacter: Character = {
    ...
    bio: [
      ...
      'Supports all core alanOS features and plugin interactions',
    ...
    messageExamples: [
      ...
      [
        ...
        },
        {
          name: 'TestAgent',
          content: {
            text: 'I can assist with testing various alanOS features including actions, providers, services, and plugin functionality.',
          },
        },
      ],
    ],
    ...
    postExamples: [
      'Testing new alanOS features today - everything looking good!',
    ...
    knowledge: [
      'alanOS architecture and patterns',
    ...
    plugins: ['@alanos/plugin-sql', '@alanos/plugin-bootstrap'],
