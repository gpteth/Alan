...
import type { ActionResult, ProviderResult, State } from '@alanos/core';
 ...
 * @example
 * ```typescript
 * import { createMockState } from '@alanos/core/test-utils';
 *
 ...
 * @example
 * ```typescript
 * import { createMockProviderResult } from '@alanos/core/test-utils';
 *
 ...
 * @example
 * ```typescript
 * import { createMockActionResult } from '@alanos/core/test-utils';
 *
