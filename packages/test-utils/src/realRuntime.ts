...
import type { Character, IAgentRuntime, Memory, Plugin, UUID } from '@alanos/core';
import { AgentRuntime, logger, stringToUuid } from '@alanos/core';
...
export class RuntimeTestHarness {
  ...
  /**
   * Loads a plugin by name from the alanOS ecosystem
